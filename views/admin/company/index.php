                ...
                <tbody>
                  <?php
									foreach ($company as $company) {
										...
										echo "<td>
											<button class='btn-edit btn btn-primary btn-xs' style='margin-right: 5px' data-id=$company->id data-name='$company->name' data-address='$company->address'> <i class='fas fa-edit'></i></button>
											<button class='btn-delete btn btn-danger btn-xs' style='margin-right: 5px' data-id=$company->id> <i class='fas fa-trash'></i></button>
											</td>";
										echo "</tr>";
									}
									?>
