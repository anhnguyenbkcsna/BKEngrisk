...
class AdminController extends BaseController
{
	...
	public function add()
	{
		...
		$role = $_POST['role'];
		echo $fname . $lname . $yob . $gender . $phone . $email . $address . $password . $role;
		// Photo
		...
		// Add new
		$add_new = User::insert($username, $password, $fname, $lname, $gender, $email, $yob, $phone, $address, $fileuploadname, $role);
