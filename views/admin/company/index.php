                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary" type="button" data-toggle="modal"
                                data-target="#addCompanyModal">Thêm mới</button>
                            <!-- Modal-->
                                        ...
                                        <form action="index.php?page=admin&controller=company&action=add" method="post">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="Tên chi nhánh"
                                                        name="name" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Địa chỉ chi nhánh</label>
                                                    <input class="form-control" type="text"
                                                        placeholder="Địa chỉ chi nhánh" name="address" />
                                                </div>
                                            </div>
                            ...
                            <div class="modal fade" id="EditCompanyModal" tabindex="-1" role="dialog"
                                aria-labelledby="EditCompanyModal" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="index.php?page=admin&controller=company&action=edit"
                                            method="post">
                                            <div class="modal-body">
                                                <input type="hidden" name="id" />
                                                <div class="form-group">
                                                    <input class="form-control" type="hidden" placeholder="Id" name="id"
                                                        readonly />
                                                </div>
                                                <div class="form-group">
                                                    <label>Tên chi nhánh</label>
                                                    <input class="form-control" type="text"
                                                        placeholder="Please enter your company" name="name" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Địa chỉ</label>
                                                    <input class="form-control" type="text"
                            ...
                            <div class="modal fade" id="DeleteCompanyModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <form action="index.php?page=admin&controller=company&action=delete"
                                            method="post">
                                            <div class="modal-body">
                                                <input type="hidden" name="id" />
                                                <p>Bạn chắc chưa ?</p>
